...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    // before(app){
    //   app.get('/api/addressData', function (req, res) {
    //     res.json({
    //       errno: 0,
    //       data: data.address
    //     });
    ...
    //   app.get('/api/getBarData', function (req, res) {
    //     res.json({
    //       errno: 0,
    //       data: data.bar
    //     });
    ...
    //   app.get('/api/getLineData', function (req, res) {
    //     res.json({
    //       errno: 0,
    //       data: data.line
    //     });
    ...
    //   app.get('/api/getPieData', function (req, res) {
    //     res.json({
    //       errno: 0,
    //       data: data.pie
    //     });
    ...
    //     let arr = data.table.slice(min, max);
    //     res.json({
    //       errno: 0,
    //       data: {
    //         table: arr,
